...
import random
root=Tk()
root.title('Grand Marcell Bellion')
...
def random_number():
    ...
    Best_Anime_Charecter["text"]="Which Items to put in the bag............."+str(Best_Anime_Charecter)    
butt=Button(root,text="The Items in the bag are",command=random_number)
